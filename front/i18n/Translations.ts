...
export const fr: typeof en = {
    ...
    transformGuestToUserExplanations: 'Vous êtes actuellement connecté avec un compte invité. La déconnexion entraînera la perte de vos données. Pour sauvegarder votre progression, veuillez vous inscrire.',
    ...
    leaderBoardHeadingFull: 'Les joueurs présentant les meilleurs scores, grâce à leur précision exceptionnelle, sont mis en lumière ici.',
...
export const sp: typeof en = {
    ...
    transformGuestToUserExplanations: 'Actualmente está conectado con una cuenta de invitado. Si cierra la sesión, perderá sus datos. Para guardar su progreso, regístrese.',
    ...
    leaderBoardHeadingFull: 'Aquí se destacan los jugadores que tienen las mejores puntuaciones, gracias a su precisión excepcional.',
    emptySelection: 'Nada'
};
