...
const TextFieldBase: React.FC<TextFieldBaseProps> = ({ placeholder = '', style, icon, iconColor, autoComplete = 'off', isSecret = false, isRequired = false, ...props }) => {
          ...
          <View style={styles.iconContainerLeft}>
            ...
            {isSecret && (
              <TouchableOpacity style={styles.iconContainerRight} onPress={() => setPasswordVisible(prevState => !prevState)}>
                {isPasswordVisible ?
                  <EyeSlash size="20" color={isFocused ? '#5f74f7' : '#394694'} variant="Bold"/>
                  : <Eye size="20" color={isFocused ? '#5f74f7' : '#394694'} variant="Bold"/>
                }
              </TouchableOpacity>
            )}
        </View>
